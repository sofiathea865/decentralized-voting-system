...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("election-governance-framework", "get-contract-info", [], deployer.address),
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block2 = chain.mineBlock([
            Tx.contractCall("election-governance-framework", "get-record", [types.uint(1)], wallet1.address),
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        // Pause contract
        let block = chain.mineBlock([
            Tx.contractCall("election-governance-framework", "emergency-pause", [], deployer.address),
        ]);
